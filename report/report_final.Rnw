...
Lastly, Table shows RMSLE for each model, which is measured from hold-out dataset. It indicates that Random Forest predicts target variable the best.
...
\bibitem{1} Y. Bengio; A. Courville; P. Vincent (2013). "Representation Learning: A Review and New Perspectives". IEEE Trans. PAMI, special issue Learning Deep Architectures. 35: 1798–1828. doi:10.1109/tpami.2013.50.
\bibitem{2} https://en.wikipedia.org/wiki/Feature_engineering
\bibitem{3} https://medium.com/@ShaliniAnanda1/an-open-letter-to-yann-lecun-22b244fc0a5a#.92x0bez05
\bibitem{4}  "What is the intuitive explanation of feature engineering in machine learning? - Quora". www.quora.com. Retrieved 2015-11-11.
\bibitem{5} Root Mean Squared Logarithmic Error, https://www.kaggle.com/wiki/RootMeanSquaredLogarithmicError
\bibitem{6} https://kaggle2.blob.core.windows.net/competitions-data/kaggle/5407/data_description.txt?sv=2015-12-11&sr=b&sig=Z69KmQHtfE3rd9zBAATba9PE9%2Bqa1oLmyPui9Vou3OA%3D&se=2016-12-06T22%3A04%3A09Z&sp=r
\bibitem{7} http://handbook.cochrane.org/chapter_16/16_1_2_general_principles_for_dealing_with_missing_data.htm
\bibitem{8} http://onlinestatbook.com/2/transformations/log.html
\bibitem{9} https://en.wikipedia.org/wiki/One-hot
\bibitem{10} http://rishy.github.io/ml/2015/04/28/l1-vs-l2-loss/
\bibitem{11} Ensemble learning, http://www.scholarpedia.org/article/Ensemble_learning
\bibitem{12} Random forest, https://www.stat.berkeley.edu/~breiman/randomforest2001.pdf
\bibitem{13} The Elements of Statistical Learning, Shrinkage methods p.61  p. 305 
