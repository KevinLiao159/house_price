...
![Display: Exploratory Data Analysis Example](../images/boxplot-FireplaceQu.png)
...
![Display: Ridge Lambda](../images/model_prediction_comparison.png)

## Key Findings

![Display: Ridge Lambda](../images/model_residual_comparison.png)
